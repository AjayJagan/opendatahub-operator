...
func (in *ModelMeshServing) DeepCopyInto(out *ModelMeshServing) {
	*out = *in
	...
	out.RestProxy = in.RestProxy
	out.RuntimeAdapter = in.RuntimeAdapter
	out.ModelMesh = in.ModelMesh
	out.ModelMeshController = in.ModelMeshController
	out.ModelController = in.ModelController
}
