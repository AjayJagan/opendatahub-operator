...
module.exports = async ({ github, core }) => {
    ...
    try {
        const latestReleaseResult = github.request('GET /repos/{owner}/{repo}/releases/latest', {
            owner,
            repo,
            issue_number,
            headers: {
        ...
        const releaseNotesResult = github.request('POST /repos/{owner}/{repo}/releases/generate-notes', {
            owner,
            repo,
            tag_name: VERSION,
        ...
        const commentsResult = github.request('GET /repos/{owner}/{repo}/issues/{issue_number}/comments', {
            owner,
            repo,
            issue_number,
            headers: {
