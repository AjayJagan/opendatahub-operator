...
func DeployManifestsFromPath(cli client.Client, owner metav1.Object, //nolint:golint,revive // Redable name.
	manifestPath string, namespace string, componentName string, componentEnabled bool) error {
