...
declare -A COMPONENT_MANIFESTS=(
    ["dashboard"]="opendatahub-io:odh-dashboard:v2.38.2-odh:manifests"
    ["workbenches/kf-notebook-controller"]="opendatahub-io:kubeflow:v1.10.0-8:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="opendatahub-io:kubeflow:v1.10.0-8:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="opendatahub-io:notebooks:v1.37.0:manifests"
    ["modelmeshserving"]="opendatahub-io:modelmesh-serving:release-0.12.0-rc0:config"
    ["kserve"]="opendatahub-io:kserve:odh-v3.0:config"
    ["kueue"]="opendatahub-io:kueue:dev:config"
    ["ray"]="opendatahub-io:kuberay:v1.4.2:ray-operator/config"
    ["trustyai"]="opendatahub-io:trustyai-service-operator:release/odh-3.0:config"
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.3.2:config"
    ["trainingoperator"]="opendatahub-io:training-operator:v1.9.0-odh-3:manifests"
    ["datasciencepipelines"]="opendatahub-io:data-science-pipelines-operator:v2.17.0:config"
    ["modelcontroller"]="opendatahub-io:odh-model-controller:odh-v3.0:config"
    ["feastoperator"]="opendatahub-io:feast:v0.55.0:infra/feast-operator/config"
