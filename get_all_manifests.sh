...
declare -A COMPONENT_MANIFESTS=(
    ["dashboard"]="opendatahub-io:odh-dashboard:v2.21.1-incubation-release:manifests"
    ["workbenches/kf-notebook-controller"]="opendatahub-io:kubeflow:v1.7.0-7:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="opendatahub-io:kubeflow:v1.7.0-7:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="opendatahub-io:notebooks:v1.15.0:manifests"
    ["modelmeshserving"]="opendatahub-io:modelmesh-serving:odh-v2.29:config"
    ["kserve"]="opendatahub-io:kserve:v0.11.1.3:config"
    ["kueue"]="opendatahub-io:kueue:v0.6.0-rhoai-2.9:config"
    ["codeflare"]="opendatahub-io:codeflare-operator:v1.2.0:config"
    ["ray"]="opendatahub-io:kuberay:v1.0.0-rhoai:ray-operator/config"
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:v1.24.0:config"
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.1.2:config"
    ["trainingoperator"]="opendatahub-io:training-operator:dev:manifests"
    ["datasciencepipelines"]="opendatahub-io:data-science-pipelines-operator:v2.0.1:config"
    ["modelcontroller"]="opendatahub-io:odh-model-controller:odh-v2.29:config"
