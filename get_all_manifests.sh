...
opendatahub-io:odh-dashboard:v2.21.1-incubation-release:manifests"
opendatahub-io:kubeflow:v1.7.0-7:components/notebook-controller/config"
opendatahub-io:kubeflow:v1.7.0-7:components/odh-notebook-controller/config"
opendatahub-io:notebooks:v1.15.0:manifests"
    ["modelmeshserving"]="opendatahub-io:modelmesh-serving:release-0.12.0-rc0:config"
opendatahub-io:kserve:v0.11.1.3:config"
opendatahub-io:kueue:v0.6.0-rhoai-2.9:config"
opendatahub-io:codeflare-operator:v1.2.0:config"
opendatahub-io:kuberay:v1.0.0-rhoai:ray-operator/config"
opendatahub-io:trustyai-service-operator:v1.24.0:config"
opendatahub-io:model-registry-operator:release/v0.1.2:config"
opendatahub-io:training-operator:dev:manifests"
opendatahub-io:data-science-pipelines-operator:v2.0.1:config"
