...
declare -A COMPONENT_MANIFESTS=(
    ...
    ["model-mesh"]="opendatahub-io:modelmesh-serving:v1.2.00:config:model-mesh"
    ["odh-model-controller"]="opendatahub-io:odh-model-controller:v1.2.01:config:odh-model-controller"
    ["kserve"]="opendatahub-io:kserve:v1.2.02:config:kserve"
    ["modelregistry"]="opendatahub-io:model-registry-operator:v1.2.03:config:model-registry-operator"
)
