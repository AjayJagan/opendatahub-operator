...
declare -A COMPONENT_MANIFESTS=(
    ...
    ["data-science-pipelines-operator"]="opendatahub-io:data-science-pipelines-operator:v2.4.x:config:data-science-pipelines-operator"
    ["odh-dashboard"]="opendatahub-io:odh-dashboard:v2.25.1-odh-release:manifests:dashboard"
    ["kf-notebook-controller"]="opendatahub-io:kubeflow:v1.7.0-14:components/notebook-controller/config:odh-notebook-controller/kf-notebook-controller"
    ["odh-notebook-controller"]="opendatahub-io:kubeflow:v1.7.0-14:components/odh-notebook-controller/config:odh-notebook-controller/odh-notebook-controller"
    ["notebooks"]="opendatahub-io:notebooks:v1.21.0:manifests:notebooks"
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:release/1.24.0:config:trustyai-service-operator"
    ...
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.2.4:config:model-registry-operator"
