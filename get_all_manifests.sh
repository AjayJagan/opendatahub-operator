...
declare -A COMPONENT_MANIFESTS=(
    ["dashboard"]="opendatahub-io:odh-dashboard:v2.33.2-odh-release:manifests"
    ["workbenches/kf-notebook-controller"]="opendatahub-io:kubeflow:v1.10.0-1:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="opendatahub-io:kubeflow:v1.10.0-1:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="opendatahub-io:notebooks:v1.30.0:manifests"
    ["modelmeshserving"]="opendatahub-io:modelmesh-serving:odh-v2.29:config"
    ["kserve"]="opendatahub-io:kserve:odh-v2.29:config"
    ...
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:release/1.37.0:config"
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.2.18:config"
    ["trainingoperator"]="opendatahub-io:training-operator:v1.9.0-odh-3:manifests"
    ["datasciencepipelines"]="opendatahub-io:data-science-pipelines-operator:v2.12.0:config"
