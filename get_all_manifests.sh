...
declare -A COMPONENT_MANIFESTS=(
    ...
    ["trustyai"]="trustyai-explainability:trustyai-service-operator:v1.24.0:config:trustyai-service-operator"
    ...
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.1.2:config:model-registry-operator"
