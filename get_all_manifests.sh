...
declare -A COMPONENT_MANIFESTS=(
    ["dashboard"]="opendatahub-io:odh-dashboard:v2.38.2-odh@a07dfb895cc2d1c2949ac70cf7fc9d68037e3ca7:manifests"
    ["workbenches/kf-notebook-controller"]="opendatahub-io:kubeflow:v1.10.0-8@9a51b0279ccf47c67df35b8096aaa1c51dd87cfb:components/notebook-controller/config"
    ["workbenches/odh-notebook-controller"]="opendatahub-io:kubeflow:v1.10.0-8@9a51b0279ccf47c67df35b8096aaa1c51dd87cfb:components/odh-notebook-controller/config"
    ["workbenches/notebooks"]="opendatahub-io:notebooks:main@d56ac81b7a36561a69e6d02a50c3e6f68dcdffb7:manifests"
    ["kserve"]="opendatahub-io:kserve:odh-v3.0@710a8a6b8e7f4432e293da474ab8cb588513a2e2:config"
    ["ray"]="opendatahub-io:kuberay:v1.4.2@b9e26fa34f9128594841fcd1df079ee2e9269fb2:ray-operator/config"
    ["trustyai"]="opendatahub-io:trustyai-service-operator:release/odh-3.0@31db48324a84b35f6eff1e2a3b53934bda67ba53:config"
    ["modelregistry"]="opendatahub-io:model-registry-operator:release/v0.3.2@a1f1e34233fce4fbcc6fa5b0a292da40fb7bccdf:config"
    ...
    ["modelcontroller"]="opendatahub-io:odh-model-controller:odh-v3.0@de75936a28afd49fc71efeaf5cc880169fb61012:config"
